    ...
    public class CardDataBase: MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            ArtWorks = new string[]
            {
                ...
                "_01", "_02", "_04", "_05", "_06", "_07", "_08", "_09", "_10", "_11", "_12", "_13", "_14", "_15", "_16", "_17", "_18", "_19", "_20"
            };
        }
        ...
        public static List<Card> GetDeck(Player P)
        {
            ...
            if (P.faction == "Ingenieros Celestiales")
            {
                ...
                Deck.Add(new Card(P.Turn, "Arqueros Espaciales", 2, 4, "No tienen efecto especial", P, TypeUnit.Silver, "U", "None", "R" + "S", Resources.Load<Sprite>("1"), true));
                ...
                Deck.Add(new Card(P.Turn, "Catapulta de Estrellas", 5, 8, "Arma de gran rango", P, TypeUnit.Silver, "U", "None", "S", Resources.Load<Sprite>("4"), true));
                ...
                Deck.Add(new Card(P.Turn, "Clon de Combate", 8, 3, "Su poder incrementa en presencia de otro clon", P, TypeUnit.Silver, "U", "Colmena", "M", Resources.Load<Sprite>("7"), true));
                ...
                Deck.Add(new Card(P.Turn, "Dragon Espacial", 10, 3, "No tiene efecto especial", P, TypeUnit.Silver, "U", "None", "M" + "R", Resources.Load<Sprite>("9"), true));
                ...
                Deck.Add(new Card(P.Turn, "Mago Tecnologico", 16, 3, "No tiene efecto especial", P, TypeUnit.Silver, "U", "None", "M" + "R", Resources.Load<Sprite>("15"), true));
                ...
                Deck.Add(new Card(P.Turn, "Nebulosa Energetica", 18, 0, "Carta Clima, afecta Distancia", P, TypeUnit.None, "C", "Weather", "R", Resources.Load<Sprite>("_14"), true));
            ...
            else if(P.faction=="Aliens Elementales")
            {
                ...
                Deck.Add(new Card(P.Turn, "Nebulosa Energ�tica", 18, 0, "Carta Clima, afecta a Distancia", P, TypeUnit.None, "C", "Weather", "R"+"S", Resources.Load<Sprite>("_14"), true));
                ...
                Deck.Add(new Card(P.Turn, "Tonico Espacial", 20, 0, "Carta Aumento, act�a sobre Distancia", P, TypeUnit.None, "AR", "Raise", "M", Resources.Load<Sprite>("_16"), true));
                Deck.Add(new Card(P.Turn, "Tormenta de Gusano", 21, 0, "Carta Clima, afecta a Asedio", P, TypeUnit.None, "C", "Weather", "S"+"M", Resources.Load<Sprite>("_17"), true));
                Deck.Add(new Card(P.Turn, "Espada Laser", 22, 0, "Carta Aumento, act�a sobre Cuerpo a Cuerpo", P, TypeUnit.None, "AM", "Raise", "M"+"R", Resources.Load<Sprite>("_18"), true));
                Deck.Add(new Card(P.Turn, "Bendicion de Houla", 23, 0, "Carta Aumento, act�a sobre Asedio", P, TypeUnit.None, "AS", "Raise", "S"+ "R", Resources.Load<Sprite>("_19"), true));
                Deck.Add(new Card(P.Turn, "Luz", 24, 0, "Despeja todo el mal tiempo de la Batalla",P, TypeUnit.None, "C", "Light", "M" + "R" + "S", Resources.Load<Sprite>("_20"), true));
        ...
        public static void CustomizeDeck(List<Card> deck)
        {
            foreach(Card card in deck)
            {
                CustomizeCard(card);
        ...
        internal static List<Card> CompleteDeck(List<Card> cartasCompiladas, Player P)
        {
            List<Card> Deck = new();
            ...
            bool leader= false;
            foreach(Card card in cartasCompiladas)
            {
                card.OnConstruction = true;
                if (card.Type=="L")
                {
        ...
        private static Card GiveMeLeader(Player P)
        {
            ...
            {
                new Card(P.Turn, "Alarion", 0, 0, "Te permite robar una carta extra por ronda", P, TypeUnit.None, "L", "Planet", "", Resources.Load<Sprite>("0"), true),
                new Card(P.Turn, "Magnus", 0, 0, "Permite conservar una carta en el campo luego de un turno", P, TypeUnit.None, "L", "Planet", "", Resources.Load<Sprite>("_01"), true)
            };
